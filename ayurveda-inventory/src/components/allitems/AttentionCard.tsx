      ...
      <div className="attention-grid">
        <div className="attn-col">
          ...
          <div className="attn-list">
            ...
            {expiringCount > 5 && <div className="attn-more">+{expiringCount - 5} more → OPEX tab</div>}
          </div>
        </div>
        ...
        <div className="attn-col">
          ...
          <div className="attn-list">
            ...
            {lowStockCount > 5 && <div className="attn-more">+{lowStockCount - 5} more → OPEX tab</div>}
          </div>
        </div>
        ...
        <div className="attn-col">
          ...
          <div className="attn-list">
            ...
            {amcDueCount > 5 && <div className="attn-more">+{amcDueCount - 5} more → CAPEX tab</div>}
          </div>
        </div>
